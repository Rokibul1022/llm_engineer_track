...
| **Phase 1: Week 2** | **Structured Output & Schema Enforcement** | 🔄 In Progress | JSON mode, tool calling schemas, strict Pydantic contract guards, self-correction loops. |
...
## 📂 Active Phase: Phase 1 Week 1 — Resilient Async LLM Client

Explore the implementation in [`phase1-week1/`](./phase1-week1/):

* **[Phase 1 Week 1 Client (`phase1-week1/llm-client/`)](./phase1-week1/llm-client/)**:
  ...
  * Real-time TTFT & decode token latency decomposition
  * Zero-network fault injection simulation engine (`POST /v1/simulate`)
  * Interactive dual-tab web dashboard and acceptance testing harness
